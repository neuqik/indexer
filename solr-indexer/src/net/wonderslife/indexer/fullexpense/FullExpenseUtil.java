...
public class FullExpenseUtil {
	...
	public static void indexByResult(List<Map<String, Object>> result,
		...
		long l1 = 0; // 循环环境变量的总耗时
		long l2 = 0; // 循环SQL的总耗时
		long l3 = 0; // add doc循环总耗时
		long l4 = 0; // join的获取连接
		long l5 = 0; // join的执行

		long each_start4 = System.currentTimeMillis();
		Connection conn = null;
		long each_end4 = System.currentTimeMillis();
		l4 = l4 + ((each_end4 - each_start4));
		try {
			...
			while (it.hasNext()) {
				...
				// row.get("BAZ001")
				// + "... ...");
				long each_start = System.currentTimeMillis();
				...
				long each_end = System.currentTimeMillis();
				l1 = l1 + ((each_end - each_start));

				long each_start2 = System.currentTimeMillis();
				// ////增加KC21部分
				//TODO:处理负交易
				...
				try {
					long each_start5 = System.currentTimeMillis();
					List<Map<String, Object>> kc21Result = JDBCUtil
							.executeQuery(sql, conn, param, false);
					long each_end5 = System.currentTimeMillis();
					l5 = l5 + ((each_end5 - each_start5));
					if (kc21Result != null & kc21Result.size() == 1) {
						fullexpense.setAAC004(String.valueOf(kc21Result.get(0)
								.get("AAC004")));
						fullexpense.setBAE450(String.valueOf(kc21Result.get(0)
								.get("BAE450")));
						fullexpense.setBKC231(String.valueOf(kc21Result.get(0)
								.get("BKC231")));
						fullexpense.setBKC232(String.valueOf(kc21Result.get(0)
								.get("BKC232")));
						fullexpense.setAKC193(String.valueOf(kc21Result.get(0)
								.get("AKC193")));
						fullexpense.setAKC195(String.valueOf(kc21Result.get(0)
								.get("AKC195")));
						fullexpense.setAKC196(String.valueOf(kc21Result.get(0)
								.get("AKC196")));
					}
				...
				long each_end2 = System.currentTimeMillis();
				l2 = l2 + ((each_end2 - each_start2));
				// /////////////////////
				long each_start3 = System.currentTimeMillis();
				docs.add(fullexpense);
				long each_end3 = System.currentTimeMillis();
				l3 = l3 + ((each_end3 - each_start3));
			...
			System.out.println("index docs commit spent:" + (end - start)
					/ 1000 + "s");
			System.out.println("index docs object spent:" + l1 + "ms");
			System.out.println("index docs join spent:" + l2 + "ms");
			System.out.println("....inside get connection spent:" + l4 + "ms");
			System.out.println("....inside execute spent:" + l5 + "ms");
			System.out.println("index docs add doc spent:" + l3 + "ms");
		} finally {
			if (conn != null)
