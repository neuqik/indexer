...
public class RecipeIndexer {
	public static void main(String[] args) {
		int pageSize = 10000; // 20条一提交solr
		int rowCount = 51091747;// 总行数
		int count = 2;// 计数器
		...
		try {
			...
			SolrServer solr = new HttpSolrServer(
					"http://192.168.2.222:8080/ssadmin/recipecore");
			solr.deleteByQuery("*:*");
			solr.commit();
			// connect to database
